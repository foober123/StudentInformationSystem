...
static const std::array<std::string,
    ...
    "Invalid Name. Cannot be empty, contain Numbers or, Special Characters",
    ...
    "Code cannot contain numbers or certain special characters except -",
    "Name cannot contain numbers or certain special characters except -,\",\",&",
